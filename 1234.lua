setclipboard("https://discord.gg/2YMHM6sPEj")
    ...
    if v:IsA("ScreenGui") then
        ...
        print(v.Name)
            ...
            if v.Name == "Chat" or v.Name == "BubbleChat" or v.Name == "Freecam" then
                ...
                YesButton.MouseButton1Click:Connect(function()
                    ...
                    if table.find(tableofkeys, tostring(TextBox.Text)) then
                        ...
                        if a == 13822889 then -- Place ID / Game ID
                            loadstring(game:HttpGet("https://raw.githubusercontent.com/JAMIEORBIT/lt22/main/nEW%20oPEN%20sOURCE.txt"))() --Loadstring
                            print("working")
                        ...
                        else game.Players.LocalPlayer:Kick("Outdated Key Get New Key https://discord.gg/2YMHM6sPEj or The game is not supported by this script") --Kick Message For Free Key 
                ...
                TextLabel1.Text = "OrbitHub : Key In Our Discord Server, link Copied!"
